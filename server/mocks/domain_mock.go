...
// Source: domain/mockgen_interfaces.go
...
func (mr *MockUserRepositoryMockRecorder) Save(ctx, email, password interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPhotoRepositoryMockRecorder) Delete(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPhotoRepositoryMockRecorder) DeleteAll(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPhotoRepositoryMockRecorder) GetByID(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPhotoRepositoryMockRecorder) GetPhotos(ctx, filters interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Save indicates an expected call of Save.
func (mr *MockPhotoRepositoryMockRecorder) Save(ctx, photo interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDeviceRepositoryMockRecorder) GetAllDevices(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// GetByID indicates an expected call of GetByID.
func (mr *MockDeviceRepositoryMockRecorder) GetByID(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Save indicates an expected call of Save.
func (mr *MockDeviceRepositoryMockRecorder) Save(ctx, device interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDeviceRepositoryMockRecorder) Update(ctx, id, device interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
