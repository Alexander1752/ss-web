...
const StatisticsPage: React.FC = () => {
    ...
    const renderChartToggle = (currentType: 'bar' | 'pie', setType: (t: 'bar' | 'pie') => void) => (
        <div className="flex bg-gray-100 dark:bg-gray-700 p-1 rounded-md">
            <button
                onClick={() => setType('bar')}
                className={`px-3 py-1 text-sm rounded-sm transition-colors ${currentType === 'bar' ? 'bg-white dark:bg-gray-600 shadow-sm text-sky-600 dark:text-sky-400 font-medium' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'
                    }`}
            >
                Bar
            </button>
            <button
                onClick={() => setType('pie')}
                className={`px-3 py-1 text-sm rounded-sm transition-colors ${currentType === 'pie' ? 'bg-white dark:bg-gray-600 shadow-sm text-sky-600 dark:text-sky-400 font-medium' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'
                    }`}
            >
                Pie
            </button>
    ...
    return (
        <div className="container mx-auto pb-10">
            <h1 className="text-2xl font-semibold text-sky-700 dark:text-sky-400 mb-6">Statistics</h1>
            ...
            {loading ? (
                ...
                <div className="bg-red-50 dark:bg-red-900/40 text-red-700 dark:text-red-300 p-4 rounded-md">{error}</div>
            ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="text-lg font-medium text-gray-800 dark:text-gray-200">Control Type Distribution</h3>
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="text-lg font-medium text-gray-800 dark:text-gray-200">Medical Opinion Results</h3>
