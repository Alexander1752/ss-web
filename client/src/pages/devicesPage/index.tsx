...
const DevicesPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto">
      <h1 className="text-2xl font-semibold text-sky-700 dark:text-sky-300 mb-6">Devices</h1>
                ...
                {devices.map(device => {
                  ...
                  return (
                    <div key={device.id} className="relative">
                      ...
                      {actionState.success && (
                        <div className="absolute top-0 right-0 left-0 bg-green-100 dark:bg-green-900/50 text-green-800 dark:text-green-300 text-sm p-2 rounded-t-lg text-center">
                      ...
                      {/* Error notification */}
                      {actionState.error && (
                        <div className="absolute top-0 right-0 left-0 bg-red-100 dark:bg-red-900/50 text-red-800 dark:text-red-300 text-sm p-2 rounded-t-lg text-center">
                          {actionState.error}
                        </div>
                      )}
